...
(defun color-theme-grb2 ()
  ...
  (color-theme-install
   '(color-theme-grb2
     ...
     (fringe ((t (:background "#f2f2f2" :foreground "#F6F3E8"))))
     ...
     (font-lock-builtin-face ((t (:foreground "#100074"))))
     ...
     (font-lock-string-face ((t (:foreground "#0eba00"))))
     ...
     (highline-face ((t (:background "#ffffff"))))
     (left-margin ((t (nil))))
